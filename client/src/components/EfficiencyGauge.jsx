        ...
        <div className="w-full xl:w-[380px] bg-white p-10 rounded-[40px] border border-slate-100 shadow-sm flex flex-col items-center">
            ...
            <div className="relative h-32 w-48 mb-10 text-center">
                <svg viewBox="0 0 100 55" className="w-full h-full overflow-visible">
                    ...
                    <path d="M10,50 A40,40 0 0,1 75,18" fill="none" stroke="#8B0000" strokeWidth="12" strokeLinecap="round" strokeDasharray="126" />
                </svg>
                <div className="absolute inset-0 flex flex-col justify-end">
                    <h4 className="text-4xl font-black text-slate-900 leading-none">1.375</h4>
                </div>
            </div>

            {showCreditInfo && (
                <div className="absolute inset-4 bg-white z-50 rounded-3xl p-6 shadow-2xl border border-slate-100 flex flex-col animate-in fade-in zoom-in duration-300">
                    ...
                    <div className="flex-1 overflow-y-auto space-y-6 text-sm text-slate-600 leading-relaxed">
                    ...
                    <button 
                        ...
                        className="mt-6 w-full bg-[#8B0000] text-white py-3 rounded-2xl text-[13px] font-black uppercase tracking-widest shadow-lg shadow-red-900/20 active:scale-95 transition-all"
                    >
                        I Understand
                    </button>
                </div>
            ...
            <div className="flex justify-between w-full mt-10 pt-8 border-t border-slate-50">
                ...
                <div className="flex flex-col items-end gap-1">
                    <span className="text-[13px] font-black text-emerald-500">84.2%</span>
